...
class FormationFlyingEnv(gym.Env):
    ...
    def reset(self):
        ...
        xpoints = np.array((0,-2,-4,2,4))
        #ypoints = np.array((0,0,0,0,0))

        ypoints = np.array((np.random.uniform(-1,0),np.random.uniform(-1,0),np.random.uniform(-1,0),np.random.uniform(-1,0),np.random.uniform(-1,0)))

        self.start_xpoints = xpoints
        self.start_ypoints = ypoints

        self.goal_xpoints = np.array((self.goal_x1,self.goal_x2,self.goal_x3,self.goal_x4,self.goal_x5))
        self.goal_ypoints = np.array((self.goal_y1,self.goal_y2,self.goal_y3,self.goal_y4,self.goal_y5))
